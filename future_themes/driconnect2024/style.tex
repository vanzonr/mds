...
{
\begin{picture}(0,0)
\put(-35.5,-153.5){\includegraphics[width=16cm,height=9cm]{%THEMETEX_HERE/firstslide.pdf}}
...
\begin{picture}(0,0)
\put(-36,-178){\includegraphics[width=16.16cm,height=9.09cm]{%THEMETEX_HERE/sectionslide.pdf}}
\end{picture}
\vspace{2cm}\\
